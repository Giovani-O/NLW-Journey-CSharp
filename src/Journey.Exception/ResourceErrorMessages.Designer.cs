...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        public static string TRIP_DATE_MUST_BE_LATER_THAN_TODAY {
            get {
                return ResourceManager.GetString("TRIP_DATE_MUST_BE_LATER_THAN_TODAY", resourceCulture);
            }
        }
        
        public static string TRIP_END_DATE_MUST_BE_LATER_THAN_START_DATE {
            get {
                return ResourceManager.GetString("TRIP_END_DATE_MUST_BE_LATER_THAN_START_DATE", resourceCulture);
            }
        }
